...
#SBATCH --output=single_subscript_slurm_output.out  # Redirect output to a file
#SBATCH --error=single_subscript_slurm_error.log  # Redirect error messages to a file
